...
export const PRINCIPLE_CARDS: PrincipleCard[] = [
  {
    ...
    area: "principios",
    weight: 3,
    thesis: "Desejo definido na fala do cliente. Campo vazio vira pergunta; persistencia e follow-up, nao motivacao.",
    apply: "Abertura da reuniao, faturamento atual vs desejado, dono da meta, primeiro passo.",
    never: "Nao copiar principio como fato. Nao inventar meta de riqueza. Nao gravar 'crescer' como objetivo definido.",
  },
  {
    id: "daniel-playbook",
  ...
  },
  {
    ...
    area: "financeira",
    weight: 1,
    thesis: "Classificar conta pelo criterio do demonstrativo. Lucro por competencia nao e caixa. EBITDA so com linhas conciliaveis.",
    apply: "Leitor DRE, honorarios 15% EBITDA, diagnostico financeiro.",
    never: "Nao chutar depreciacao. Nao tratar EBITDA como caixa. Nao misturar funcao com natureza sem mapa.",
  },
  {
    id: "porter",
    ...
    area: "clientes",
    weight: 1,
    thesis: "Cinco forcas e custo/diferenciacao/enfoque so com fato na sessao ou documento. SWOT vazia vira pergunta.",
    apply: "SWOT, mix comercial, pesquisa R, proposta de valor.",
    never: "Nao copiar case do livro. Preco baixo nao e lideranca em custo. Nao afirmar mercado sem evidencia.",
  },
  {
    id: "outsiders",
    title: "The Outsiders",
  ...
  },
  {
    ...
    area: "financeira",
    weight: 1,
    thesis: "Ultrapassar a variacao: liquidez, endividamento, NCG e ciclo so com conta e periodo casados.",
    apply: "Diagnostico financeiro, NCG, leitura de estrutura alem de 'caiu X%'.",
    never: "Nao concluir insolvencia com um unico indice. Nao inventar media setorial. Nao misturar caixa com competencia.",
  },
  {
    id: "alexander",
  ...
  },
  {
    ...
    area: "aprendizagem",
    weight: 1,
    thesis: "GUT de equipe vira cargo, ocupante, competencia evidenciada e sucessor — ou ausencia expressa de sucessor.",
    apply: "Processo critico, organograma, risco de concentracao, perspectiva aprendizagem.",
    never: "Nao inventar cargo. Nao pontuar pessoa. Nao presumir sucessor pelo subordinado.",
  },
  {
    id: "drucker",
  ...
  },
  {
    ...
    area: "financeira",
    weight: 2,
    thesis: "Objetivo so fecha com indicador, meta, iniciativa, dono e cadencia de revisao. Planejado vs realizado no mesmo periodo.",
    apply: "Mapa BSC, ritual mensal E, teste de hipotese causal.",
    never: "Nao copiar mapa. Nao gravar KPI sem dono. Nao preencher realizado com estimativa.",
  },
  {
    id: "sfo",
